        ...
        <section className="job-wrap">
            <div className="job-wrap__inner">
                ...
                <div className="job-list-wrap">
                    <div className="job-list__item icon project-software-icon">
                        <h3 className="title custom-border">Senior Software Engineer</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                        <div className="button-wrap">
                            <Link to="/jobdetail/" className="button button-plain">Apply</Link>
                        </div>
                    </div>

                    <div className="job-list__item icon project-frontend-icon">
                        <h3 className="title custom-border">Senior Software Engineer</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                        <div className="button-wrap">
                            <Link to="/jobdetail/" className="button button-plain">Apply</Link>
                    ...
                    <div className="job-list__item icon project-mobile-icon">
                        <h3 className="title custom-border">Senior Software Engineer</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                        <div className="button-wrap">
                            <Link to="/jobdetail/" className="button button-plain">Apply</Link>
